...
/**
 * Input component implementation for string selection requests.
 * 
 * @author totalwarANGEL
 */
@SuppressWarnings("serial")
public class InputComponentStringBox extends JPanel implements InputComponent
{
     ...
     * @param h Height
     */
    public InputComponentStringBox(final int w, final int h)
    {
        this.w = w;
        this.h = h;
        build();
    ...
    public void demo()
    {
        setOptions(Arrays.asList("Option A", "Option B", "Option C"));
    }
    ...
    public static void main(final String[] args)
    {
        ...
        final InputComponentStringBox test = new InputComponentStringBox(width, 40);
        test.demo();
