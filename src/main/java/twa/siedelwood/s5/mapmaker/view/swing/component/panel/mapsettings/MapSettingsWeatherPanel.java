...
public class MapSettingsWeatherPanel extends MapSettingsBasePanel {
    ...
    public void initPanel() {
        ...
        infoRandomWeather = new JLabel(
            "<html>" +
            "Aktiviere diese Option, wenn automatische Wetterwechsel für das ausgewählte Set generiert werden sollen.<br>" +
            "<b>Hinweis</b>: Wetterwechsel sind zufällig und können zu unvorteilhaften Konstellationen führen!" +
            "</html>");
